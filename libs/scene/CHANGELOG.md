...
- Update resource management API
- Improve text rendering support
...
- Supports copying animation clips at runtime
...
- Add TAA support
- Add blueprint material support

### Patches

- Fix crash due to memory leak
